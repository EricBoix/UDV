...
*/
// ===========================================================================
// For some reason (related to how this file is imported) we cannot seem
// to be able to use export (next commented out line)....
// export { Setup3DScene as default };

export function Setup3DScene(
    terrainAndElevationRequest,
